...
def listen_print_loop(responses,total_text):
    ...
    for response in responses:
        ...
        if not result.is_final:
            ...
            tmp_sentence = transcript + overwrite_chars
            print(tmp_sentence)
            total_text.append(tmp_sentence.strip()+".")

            if re.search('회의 종료', tmp_sentence, re.I):
                print('Exiting..')
                tmp_text = ''''''
...
def main():
    ...
    with MicrophoneStream(RATE, CHUNK) as stream:
        ...
        listen_print_loop(responses,total_text)
